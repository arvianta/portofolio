const jobs = [
  ...
  },
  {
    ...
    description: [
      ...
      "Implemented RESTful APIs using Laravel and MySQL to integrate the web application with the data given from climate sensors in the field",
    ],
    url: "",
  },
  {
    ...
    description: [
      "Acted as a backend engineer for one of Indocor's event, ICW (Indonesian Corrosion Week), developed API for competition registration web application with login and registration feature using Laravel and MySQL",
    ],
  },
];
